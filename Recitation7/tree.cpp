...
// traverse to the end of the trees and use recursion to delete.
//once you get to the leaves you will delete
...
Node *sum = new Node(0);
sum->data = node->data;
sum->data = sum->data + sumNodes(node->right);
sum->data = sum->data + sumNodes(node->left);
